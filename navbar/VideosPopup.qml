...
PanelWindow {
    ...
    Behavior on reveal {
        NumberAnimation {
            duration: videosPopup.root.videosVisible ? 220 : 140
            easing.type: videosPopup.root.videosVisible ? Easing.OutCubic : Easing.InCubic
        }
    }

    MouseArea {
        anchors.fill: parent
        onClicked: videosPopup.root.videosVisible = false
    }
    ...
    Rectangle {
        ...
        color: videosPopup.root.bg
        border.color: videosPopup.root.sep
        border.width: 1
        radius: 0
        ...
        focus: videosPopup.root.videosVisible
        ...
        Column {
            ...
            Item {
                ...
                Row {
                    ...
                    CalendarChevron {
                        ...
                        restColor: videosPopup.root.sumi
                        font.pixelSize: 24
                    ...
                    delegate: Item {
                        ...
                        MouseArea {
                            ...
                            onPositionChanged: (e) => {
                                ...
                                // Hyprland blocks layer-shell surfaces from
                                // serving as Wayland DnD sources, so we
                                // hand off to dragon-drop: a tiny
                                // xdg-toplevel that holds the file and can
                                // be dragged onto any drop target.
                                // -x exits after one accepted drop;
                                // --on-top keeps the handle above Kdenlive
                                // while you grab it. If the binary is
                                // missing the popup just dismisses;
                                // right-click URI copy remains the
                                // keyboard fallback.
            ...
            Item {
                ...
                Text {
                    ...
                    color: copied ? videosPopup.root.seal : videosPopup.root.sumi
                    font.family: videosPopup.root.mono
                    font.pixelSize: 11
                    font.letterSpacing: 2
