...
PanelWindow {
    ...
    Behavior on reveal {
        NumberAnimation {
            duration: aetherPopup.root.aetherVisible ? 220 : 140
            easing.type: aetherPopup.root.aetherVisible ? Easing.OutCubic : Easing.InCubic
        }
    }

    MouseArea {
        anchors.fill: parent
        onClicked: aetherPopup.root.aetherVisible = false
    }
    ...
    Rectangle {
        ...
        color: aetherPopup.root.bg
        border.color: aetherPopup.root.sep
        border.width: 1
        radius: 0
        ...
        focus: aetherPopup.root.aetherVisible
        ...
        Column {
            ...
            Item {
                ...
                Text {
                    ...
                    color: aetherPopup.root.aetherQuery.length === 0 ? aetherPopup.root.sumi : aetherPopup.root.ink
            ...
            Rectangle { width: parent.width; height: 1; color: aetherPopup.root.sep; opacity: 0.5 }
